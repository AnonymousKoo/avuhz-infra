...
1. obtain owner review and, if desired, separately create the exact approval for pristine `development-auth-provider-read-diagnostic-v1`; do not execute it or retry the consumed inspection under preparation authority;
