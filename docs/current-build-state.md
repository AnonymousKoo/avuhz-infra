...
1. separately review and, if accepted, record an exact owner approval for `development-auth-v32-synthetic-session-cleanup-v1`; do not execute it under preparation authority;
