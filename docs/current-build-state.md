...
1. prepare a fresh, exact synthetic-session cleanup boundary for the single attributed DEVELOPMENT AUTH session; do not clean it up under the consumed attribution authority;
2. keep refresh-token state unresolved unless a separately authorized boundary reads or safely resolves it;
