...
- `development-auth-v32-session-inspection-v1` prepares one `PROVIDER_READ` step over the exact DEVELOPMENT AUTH project using the existing environment-bound provider-read credential reference. Plan `8a1300d3-4bfb-461c-90c4-a22a53a11647`, plan digest `sha256:c397fc40fe5622047ab38d435ebad57f119a2b7882103ef0d175e39ee0d5bdf1`, and pristine progress digest `sha256:2d64cadde4b6b3686b13e00fd3d2fe2e92066d53ce2c51c0c27d56b0cb253d60` are `READY_FOR_APPROVAL / NOT_STARTED / PENDING`. No approval, execution progress, or execution evidence exists; provider contact and cleanup remain unauthorized.
...
The recovery-inspection boundary `development-auth-v32-session-inspection-v1` has plan id `8a1300d3-4bfb-461c-90c4-a22a53a11647`, plan digest `sha256:c397fc40fe5622047ab38d435ebad57f119a2b7882103ef0d175e39ee0d5bdf1`, and pristine progress digest `sha256:2d64cadde4b6b3686b13e00fd3d2fe2e92066d53ce2c51c0c27d56b0cb253d60`. It is `READY_FOR_APPROVAL`, unapproved, unexecuted, and limited to one `provider.auth-session-state.inspect-read-only` step using credential class `SUPABASE_PROVIDER_READ`; its existing environment reference is named only in workflow configuration. It can classify project-wide 0/0 as clean or bind every nonzero row to the canonical subject digest, but it cannot issue tokens, retry v32, or clean sessions.
...
1. obtain owner review of the pristine `development-auth-v32-session-inspection-v1` plan and, if accepted, separately canonicalize an exact owner approval before any provider read;
2. execute and record only that read-only inspection in a later separately authorized task; any nonzero result may inform but never authorize cleanup;
...
- Do not retry AUTH v31 or v32. Do not prepare v33, issue another synthetic token, execute the prepared session inspection without its own exact owner approval, clean provider session state, or reuse any v32 credential/authority.
