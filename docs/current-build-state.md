...
1. obtain owner review of the canonical `SESSION_INSPECTION_PROJECT_READ_FAILED` outcome and separately authorize any narrow diagnosis of the provider-read boundary; do not retry the consumed inspection;
