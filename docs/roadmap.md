...
9. Complete engineering and production readiness.
   ...
   3. Implement the local transactional outbox delivery worker with a fake local sink. — NEXT
   4. Implement the local CI artifact/evidence pipeline and autonomous dry-run harness. — NOT STARTED
