#!/usr/bin/env python3
"""Execute the separately approved one-GET provider-read diagnostic.
...
PROGRESS_PATH = (
    ROOT
    / "contracts/plans/v1/development-auth-provider-read-diagnostic-v1.progress.json"
)
APPROVAL_PATH = (
    ROOT
    / "contracts/plans/v1/development-auth-provider-read-diagnostic-v1.approval.json"
)
...
CAPABILITY_BINDING_ID = (
    "binding.development.auth.provider-read-diagnostic-v1.provider-read-executor"
)
