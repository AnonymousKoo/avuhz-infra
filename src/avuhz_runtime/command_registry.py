...
COMMANDS = {
    ...
    "RecordAssessmentAccessApproval": CommandDefinition("RecordAssessmentAccessApproval", "ASSESSMENT_ACCESS_GRANT", 1, "urn:avuhz:schema:contracts:commands:record-assessment-access-approval-payload:v1", 1),
