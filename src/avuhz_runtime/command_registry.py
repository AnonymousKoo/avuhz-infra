...
COMMANDS = {
    ...
    "RecordDiagnosticAgreementAuthority": CommandDefinition("RecordDiagnosticAgreementAuthority", "DIAGNOSTIC_AGREEMENT_AUTHORITY", 1, "urn:avuhz:schema:contracts:commands:record-diagnostic-agreement-authority-payload:v1", 1, required_capability="diagnostic_agreement:record"),
    "RecordDiagnosticPaymentVerification": CommandDefinition("RecordDiagnosticPaymentVerification", "DIAGNOSTIC_PAYMENT_VERIFICATION", 1, "urn:avuhz:schema:contracts:commands:record-diagnostic-payment-verification-payload:v1", 1, required_capability="diagnostic_payment:record"),
    "InvalidateDiagnosticPaymentVerification": CommandDefinition("InvalidateDiagnosticPaymentVerification", "DIAGNOSTIC_PAYMENT_VERIFICATION", 1, "urn:avuhz:schema:contracts:commands:invalidate-diagnostic-payment-verification-payload:v1", 1, required_capability="diagnostic_payment:invalidate"),
