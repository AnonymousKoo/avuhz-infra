...
SCHEMA_FILES = (
    ...
    "domain/phase5d-common.schema.json", "domain/implementation-brief.schema.json", "domain/implementation-authorization.schema.json",
    ...
    "read-models/implementation-brief-readiness-view.schema.json", "read-models/implementation-authorization-status-view.schema.json",
)
