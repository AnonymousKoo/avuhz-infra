...
SCHEMA_FILES = (
    ...
    "commands/start-build-execution.payload.schema.json", "commands/complete-build-execution.payload.schema.json",
    ...
    "domain/phase5d-delivery-common.schema.json", "domain/build-execution-result.schema.json",
