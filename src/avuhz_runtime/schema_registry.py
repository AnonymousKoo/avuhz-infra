...
SCHEMA_FILES = (
    ...
    "domain/acquisition-handoff.schema.json", "domain/engagement.schema.json", "domain/human-approval.schema.json", "domain/diagnostic-scope.schema.json", "domain/diagnostic-agreement-authority.schema.json", "domain/diagnostic-payment-verification.schema.json", "domain/assessment-access-grant.schema.json", "domain/assessment-access-proposal.schema.json", "domain/oia-common.schema.json", "domain/oia-assessment.schema.json", "domain/oia-evidence-item.schema.json", "domain/oia-observation.schema.json", "domain/oia-root-cause.schema.json", "domain/oia-methodology-common.schema.json", "domain/oia-assessment-plan.schema.json", "domain/oia-inspection-item.schema.json",
