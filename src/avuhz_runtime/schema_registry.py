...
SCHEMA_FILES = (
    ...
    "commands/accept-acquisition-handoff.payload.schema.json", "commands/open-engagement.payload.schema.json", "commands/submit-diagnostic-scope.payload.schema.json", "commands/record-human-approval.payload.schema.json", "commands/record-assessment-access-approval.payload.schema.json", "commands/create-assessment-access-proposal.payload.schema.json", "commands/issue-assessment-access-grant.payload.schema.json", "commands/verify-assessment-access.payload.schema.json", "commands/expire-assessment-access.payload.schema.json", "commands/revoke-assessment-access.payload.schema.json", "commands/close-assessment-access-for-agreement-end.payload.schema.json", "commands/approve-diagnostic-scope.payload.schema.json", "commands/canonicalize-diagnostic-scope.payload.schema.json",
    "domain/acquisition-handoff.schema.json", "domain/engagement.schema.json", "domain/human-approval.schema.json", "domain/diagnostic-scope.schema.json", "domain/diagnostic-agreement-authority.schema.json", "domain/diagnostic-payment-verification.schema.json", "domain/assessment-access-grant.schema.json", "domain/assessment-access-proposal.schema.json",
