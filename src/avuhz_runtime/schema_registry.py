...
SCHEMA_FILES = (
    ...
    "domain/acquisition-handoff.schema.json", "domain/engagement.schema.json", "domain/human-approval.schema.json", "domain/diagnostic-scope.schema.json", "domain/diagnostic-agreement-authority.schema.json", "domain/diagnostic-payment-verification.schema.json", "domain/assessment-access-grant.schema.json",
