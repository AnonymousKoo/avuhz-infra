...
SCHEMA_FILES = (
    ...
    "commands/accept-acquisition-handoff.payload.schema.json", "commands/open-engagement.payload.schema.json", "commands/submit-diagnostic-scope.payload.schema.json", "commands/record-human-approval.payload.schema.json", "commands/approve-diagnostic-scope.payload.schema.json", "commands/canonicalize-diagnostic-scope.payload.schema.json",
