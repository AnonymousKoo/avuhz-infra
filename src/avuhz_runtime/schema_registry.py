...
SCHEMA_FILES = (
    ...
    "commands/draft-implementation-brief.payload.schema.json", "commands/revise-implementation-brief.payload.schema.json", "commands/record-implementation-brief-approval.payload.schema.json", "commands/approve-implementation-brief.payload.schema.json",
    "commands/propose-implementation-authorization.payload.schema.json", "commands/revise-implementation-authorization.payload.schema.json", "commands/record-implementation-authorization-approval.payload.schema.json", "commands/activate-implementation-authorization.payload.schema.json", "commands/revoke-implementation-authorization.payload.schema.json",
    "commands/draft-codex-build-package.payload.schema.json", "commands/revise-codex-build-package.payload.schema.json", "commands/record-codex-build-package-approval.payload.schema.json", "commands/release-codex-build-package.payload.schema.json",
    "commands/start-build-execution.payload.schema.json", "commands/complete-build-execution.payload.schema.json", "commands/record-qa-result.payload.schema.json",
    ...
    "domain/phase5d-common.schema.json", "domain/implementation-brief.schema.json", "domain/implementation-authorization.schema.json", "domain/codex-build-package.schema.json",
    "domain/phase5d-delivery-common.schema.json", "domain/build-execution-result.schema.json", "domain/qa-result.schema.json",
    ...
    "read-models/implementation-brief-readiness-view.schema.json", "read-models/implementation-authorization-status-view.schema.json", "read-models/codex-build-package-readiness-view.schema.json",
    "read-models/build-execution-status-view.schema.json", "read-models/qa-result-status-view.schema.json",
)
