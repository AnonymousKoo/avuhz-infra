...
SCHEMA_FILES = (
    ...
    "read-models/engagement-summary.schema.json", "read-models/onboarding-readiness.schema.json", "read-models/oia-findings-summary-view.schema.json",
)
