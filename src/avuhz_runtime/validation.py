...
class CommandValidator:
    ...
    def _composed_schema(self, definition: CommandDefinition) -> dict[str, Any]:
        ...
        elif definition.command_type in ("RecordOIAConversionDecision", "ProposeOngoingAgreement", "RecordOngoingPaymentVerification", "ProposeOngoingAccessGrant", "InitiateOngoingOffboarding", "DraftImplementationBrief", "ProposeImplementationAuthorization", "DraftCodexBuildPackage"):
