...
def main() -> int:
    ...
    if actual_approval_paths != expected_approval_paths:
        raise SystemExit(
            "approval artifact set differs from the exact authorized AUTH v8-v16 plus v19/v21/v22, optional exact v24, exact v25/v26/v27/v28, and DATA v1-v3 and DATA search-path-repair v1 approvals"
        )
