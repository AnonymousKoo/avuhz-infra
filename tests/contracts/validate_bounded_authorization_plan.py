...
def main() -> int:
    ...
    require(
        approval_paths == {V8_APPROVAL_PATH, V9_APPROVAL_PATH, V10_APPROVAL_PATH},
        "approval artifact set differs from the exact authorized v8/v9/v10 approvals",
    )
    require(
        ...
        "exact authorized v8/v9/v10 approval file digest mismatch",
    )
    require(
        v8_approval
        == {
