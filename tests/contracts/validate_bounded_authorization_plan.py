...
def main() -> int:
    ...
    require(
        ...
        "approval artifact set differs from the exact authorized v8/v9/v10/v11/v12/v13 approvals",
    )
    require(
        ...
        "exact authorized v8/v9/v10/v11/v12/v13 approval file digest mismatch",
    )
    require(
        v8_approval
        == {
