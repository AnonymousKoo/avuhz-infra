...
IDS = {
    "receipt": "urn:avuhz:schema:contracts:orchestration:inbound-event-receipt:v1",
    "idempotency": "urn:avuhz:schema:contracts:orchestration:idempotency-record:v1",
...
PHASE5D_COMMANDS = ["DraftImplementationBrief", "ReviseImplementationBrief", "RecordImplementationBriefApproval", "ApproveImplementationBrief", "ProposeImplementationAuthorization", "ReviseImplementationAuthorization", "RecordImplementationAuthorizationApproval", "ActivateImplementationAuthorization", "RevokeImplementationAuthorization", "DraftCodexBuildPackage", "ReviseCodexBuildPackage", "RecordCodexBuildPackageApproval", "ReleaseCodexBuildPackage"] + ["StartBuildExecution", "CompleteBuildExecution", "RecordQAResult", "RecordClientAcceptance", "ProposeDeploymentAuthorization", "ReviseDeploymentAuthorization", "RecordDeploymentAuthorizationApproval", "ActivateDeploymentAuthorization", "RevokeDeploymentAuthorization"]
PHASE5D_EVENTS = ["implementation_brief.drafted", "implementation_brief.revised", "implementation_brief.approval_recorded", "implementation_brief.approved", "implementation_authorization.proposed", "implementation_authorization.revised", "implementation_authorization.approval_recorded", "implementation_authorization.activated", "implementation_authorization.revoked", "codex_build_package.drafted", "codex_build_package.revised", "codex_build_package.approval_recorded", "codex_build_package.released"] + ["build_execution.started", "build_execution.completed", "qa_result.recorded", "client_acceptance.recorded", "deployment_authorization.proposed", "deployment_authorization.revised", "deployment_authorization.approval_recorded", "deployment_authorization.activated", "deployment_authorization.revoked"]
