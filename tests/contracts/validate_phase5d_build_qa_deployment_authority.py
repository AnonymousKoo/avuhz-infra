...
def main():
 ...
 if set(COMMANDS_C)&set(COMMANDS):fail("architecture commands leaked into runtime")
 if len(SCHEMA_FILES)!=124:fail("runtime schema registry changed")
 ...
 print("phase5d-c validation: PASS (4 resources, 9 commands, 8 capabilities, 9 events, 5 read models, 3 industries, security/stale-source negatives, runtime registry unchanged)")
