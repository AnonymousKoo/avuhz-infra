...
TABLES = (
    "avuhz_deployment_verifications", "avuhz_deployment_executions", "avuhz_deployment_authorizations", "avuhz_client_acceptances", "avuhz_qa_results", "avuhz_build_execution_results", "avuhz_codex_build_packages",
