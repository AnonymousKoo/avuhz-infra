...
from avuhz_runtime.phase5d_deployment_execution import DEPLOYMENT_EXECUTION_COMMANDS
from avuhz_runtime.phase5d_deployment_verification import DEPLOYMENT_VERIFICATION_COMMANDS
class Tests(unittest.TestCase):
 def test_registry_is_exactly_active_surface(self):
  expected={"AcceptAcquisitionHandoff","OpenEngagement"}|set(IMPLEMENTATION_BRIEF_COMMANDS)|set(IMPLEMENTATION_AUTHORIZATION_COMMANDS)|set(CODEX_BUILD_PACKAGE_COMMANDS)|set(BUILD_EXECUTION_COMMANDS)|set(QA_RESULT_COMMANDS)|set(CLIENT_ACCEPTANCE_COMMANDS)|set(DEPLOYMENT_AUTHORIZATION_COMMANDS)|set(DEPLOYMENT_EXECUTION_COMMANDS)|set(DEPLOYMENT_VERIFICATION_COMMANDS)
